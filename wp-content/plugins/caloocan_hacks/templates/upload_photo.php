...
?>
  <h2 style="text-align:center">YOUR IP ADDRESS: <br>
    <span style="font-weight:bolder; font-size: 3rem;"><?php echo getUserIpAddr(); ?> </span>
  </h2>
...
<htmL>
  ...
  <div class="diba" >
      <form  method="post" enctype="multipart/form-data" style="margin: 0 auto; width: 100%;">
        ...
        <div class="form-control">
            <label for="message">What Incident</label>
             ...
             <select  name="reportsfile">
                ...
                <label for="mediums"> I am / Sent Photo Incident</label>
            <select  name="mediums">
               <option value="victim">Victim</option>
               <option value="cocamera">Caught On Camera</option>
                 <br>
           </select>

            <label> Upload Report Incident here:</label>

                   <input type="file" name="wpcfu_file" class="form-control"  >
        ...
        <button type="submit" name="submits" style="float:right">Submit</button>
...
if (  isset( $_POST['submits'] ) ) {
            ...
            $allowed_extensions = array( 'jpg', 'jpeg', 'png', 'txt', 'doc', 'pdf');
            ...
            $allowed_file_size = 5632000000; // Here we are setting the file size limit to 500 KB = 500 × 1024
          ...
          //  These files need to be included as dependencies when on the front end.
            ...
            //  wp_die( $attachment_id->get_error_message() );
              ...
              $getlinks =  get_the_permalink( $attachment_id ) ;

            }

          echo    "xxxxxxxxxxxx" . $getlinks;
...
//          </script>";
//  }else{
//    //http://iscphack2022.elementfx.com/caloocanhackz-dashboard/
//    echo "error";
//  }
//
// }

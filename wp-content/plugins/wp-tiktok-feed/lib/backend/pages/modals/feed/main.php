				...
				<div class="media-frame-toolbar" style="left:0;">
					<div class="media-toolbar">
						...
						<div class="media-toolbar-primary search-form">
							...
							<!-- <button type="submit" class="media-modal-submit button button-primary media-button button-large " <# if ( data.source != undefined ) { #>disabled="disabled"<# } #>><?php esc_html_e( 'Save' ); ?></button> -->
							<!-- TODO: check conditional <button type="submit" class="media-modal-submit button button-primary media-button button-large " <# if ( data.source != undefined || (data.source == 'username' && data.open_id == 'undefined') ) { #>disabled="disabled"<# } #>><?php esc_html_e( 'Save' ); ?></button> -->
